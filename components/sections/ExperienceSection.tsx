...
export function ExperienceSection({ experience, education }: ExperienceSectionProps) {
  ...
  return (
    <section id="experience" className="section-padding relative perf-section">
      {/* Dynamic Background Accents */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-1/4 -right-1/4 w-[600px] h-[600px] bg-primary/5 rounded-full blur-[100px] mix-blend-screen" />
        <div className="absolute -bottom-1/4 -left-1/4 w-[500px] h-[500px] bg-purple-500/5 rounded-full blur-[100px] mix-blend-screen" />
      </div>
            ...
            {activeTab === "work" ? (
              ...
              >
                {resolvedExperience.map((exp, idx) => (
                  ...
                  >
                    {/* Glow wrapper */}
                    <div className="absolute inset-0 rounded-2xl sm:rounded-[2rem] bg-gradient-to-br from-primary/20 via-transparent to-purple-500/20 opacity-0 group-hover:opacity-100 blur-xl transition-opacity duration-700 pointer-events-none" />
                    
                    {/* Gradient Border */}
                    <div className="relative p-[1px] rounded-2xl sm:rounded-[2rem] bg-gradient-to-b from-border/80 to-border/20 group-hover:from-primary/50 group-hover:to-purple-500/30 transition-all duration-500 overflow-hidden">
                      {/* Inner Card */}
                      <div className="relative bg-card/80 backdrop-blur-xl rounded-[calc(1rem-1px)] sm:rounded-[calc(2rem-1px)] p-5 sm:p-8 transition-all duration-500 group-hover:bg-card/90 flex flex-col sm:flex-row gap-6 sm:gap-8 items-start">
                        
                        {/* Icon Block */}
                        <div className="shrink-0 relative hidden sm:block">
                          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-background to-muted/50 flex items-center justify-center border border-border/50 shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)] group-hover:scale-110 group-hover:shadow-[0_0_20px_rgba(255,23,68,0.2)] transition-all duration-500 ease-out">
                            <Briefcase className="w-8 h-8 text-primary/60 group-hover:text-primary transition-colors duration-500" />
                          </div>
                        </div>
                        ...
                        <div className="flex-1 w-full space-y-4">
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                            <div>
                              ...
                              <h3 className="text-xl sm:text-2xl font-bold font-heading text-foreground group-hover:text-primary transition-colors duration-300">
                                {exp.title}
                              </h3>
                  ...
                  >
                    ...
                    <div className="relative p-[1px] rounded-2xl sm:rounded-[2rem] bg-gradient-to-b from-border/80 to-border/20 group-hover:from-primary/50 group-hover:to-purple-500/30 transition-all duration-500 overflow-hidden">
                      ...
                      <div className="relative bg-card/80 backdrop-blur-xl rounded-[calc(1rem-1px)] sm:rounded-[calc(2rem-1px)] p-5 sm:p-8 transition-all duration-500 group-hover:bg-card/90 flex flex-col sm:flex-row gap-6 sm:gap-8 items-start">
                        ...
                        <div className="shrink-0 relative hidden sm:block">
                          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-background to-muted/50 flex items-center justify-center border border-border/50 shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)] group-hover:scale-110 group-hover:shadow-[0_0_20px_rgba(255,23,68,0.2)] transition-all duration-500 ease-out">
                            <GraduationCap className="w-8 h-8 text-primary/60 group-hover:text-primary transition-colors duration-500" />
                          </div>
                        </div>
