...
export const CraftsCards = ({
  ...
  useEffect(() => {
    ...
    const update = () =>
      setSpacing(mq.matches ? cardSpacing : Math.round(cardSpacing * 0.125));
    update();
  ...
  return (
    <div className="relative w-full overflow-hidden">
      <div className="relative flex w-full items-center justify-center h-[430px] sm:h-[450px] md:h-[500px]">
        <motion.div
          ref={ref}
